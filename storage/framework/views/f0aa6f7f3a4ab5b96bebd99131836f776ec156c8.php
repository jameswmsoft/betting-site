                        ...
                        <ul class="sub-menu">
                            ...
                            <li id="picgames">
                                ...
                                <ul class="sub-menu" style="display: block;">
                                    <li class="open">
                                        <a href="<?php echo e(url('agent/games/winnerlist/0')); ?>" <?php if($type == 0): ?> style="background-color: #0082ab!important;" <?php endif; ?>>
                                            <i class="icon-users"></i>
                                            3D LOT WINNERS</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('agent/games/winnerlist/1')); ?>" <?php if($type == 1): ?> style="background-color: #0082ab!important;" <?php endif; ?>>
                                            <i class="icon-users"></i>
                                            4D PRIME WINNERS</a>
                                    </li>
                                </ul>
                ...
                <div class="row buy_list">
                    <div class="col-sm-12 col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <?php else: ?>
                                <div class="panel-heading g_title">4D PRIME GAME WINNERS</div>
                            <?php endif; ?>

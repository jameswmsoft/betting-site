                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="panel panel-default games">
                                    ...
                                    <div class="panel-body g_draw_content g_detail">
                                        ...
                                        <p>Single bet cost : <?php echo e($nowgame->ticketCost); ?> ₹</p>
                                        <p>Winning Prize :</p>
                                        <p>ABC digit match = <?php echo e($nowgame->prizeOne); ?> ₹</p>
                                        <p>BC digit match = <?php echo e($nowgame->prizeTwo); ?> ₹</p>
                                        <p>C digit match = <?php echo e($nowgame->prizeThr); ?> ₹</p>
                                        <hr>
                                        <p>start date = <?php echo e($nowgame->start_date); ?></p>
                                        <p>end date = <?php echo e($nowgame->end_date); ?></p>

                                        <a href="<?php echo e(url('agent/games/do_pic_play')); ?>/<?php echo e($nowgame->id); ?>" class="btn btn-primary">PLAY</a>
                                    </div>

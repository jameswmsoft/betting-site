...
<head>
    ...
    <link href="<?php echo e(asset('back/css/bootstrap.min.css')); ?>" rel="stylesheet">
    <!--Activeit Stylesheet [ REQUIRED ]-->
    <link href="<?php echo e(asset('back/css/activeit.min.css')); ?>" rel="stylesheet">
    <!--Font Awesome [ OPTIONAL ]-->
    <link href="<?php echo e(asset('back/plugins/font-awesome/css/font-awesome.min.css')); ?>" rel="stylesheet">
    <!--Demo [ DEMONSTRATION ]-->
    <link href="<?php echo e(asset('back/css/demo/activeit-demo.min.css')); ?>" rel="stylesheet">

    <!--SCRIPT-->
    <!--Page Load Progress Bar [ OPTIONAL ]-->
    <link href="<?php echo e(asset('back/plugins/pace/pace.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/admin/login.css')); ?>" rel="stylesheet">
    ...
    <!-- modernizr css -->
    <script src="<?php echo e(asset('back/plugins/pace/pace.min.js')); ?>"></script>
    ...
    <div class="cls-content">
        <div class="cls-content-sm panel panel-colorful panel-login" style="margin-top: 150px !important;">
            <div class="panel-body" style="padding-top: 50px">
                ...
                <form class="form" action="<?php echo e(url('postLogin')); ?>" method="post">
...
<!--jQuery [ REQUIRED ]-->
<script src="<?php echo e(asset('back/js/jquery-2.1.1.min.js')); ?>"></script>

<!--BootstrapJS [ RECOMMENDED ]-->
<script src="<?php echo e(asset('back/js/bootstrap.min.js')); ?>"></script>

<!--Activeit Admin [ RECOMMENDED ]-->
<script src="<?php echo e(asset('back/js/activeit.min.js')); ?>"></script>

<!--Background Image [ DEMONSTRATION ]-->
<script src="<?php echo e(asset('back/js/demo/bg-images.js')); ?>"></script>

<!--Bootbox Modals [ OPTIONAL ]-->
<script src="<?php echo e(asset('back/plugins/bootbox/bootbox.min.js')); ?>"></script>

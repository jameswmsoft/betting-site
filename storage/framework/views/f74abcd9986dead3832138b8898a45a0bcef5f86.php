                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if($user->ban == '1'): ?>
                                                                            <a href="<?php echo e(url('admin/agent/do_agent_ban')); ?>/<?php echo e($user->id); ?>" class="btn btn-primary contentDelete" type="button">Ban</a>
                                                                        <?php else: ?>
                                                                            <a href="<?php echo e(url('admin/agent/do_agent_active')); ?>/<?php echo e($user->id); ?>" class="btn btn-warning contentDelete" type="button">Active</a>
                                                                        <?php endif; ?>
                                                                        <a href="<?php echo e(url('admin/agent/show_edit_agent')); ?><?php echo e('/'.$user->id); ?>" class="btn btn-primary" type="button">Edit</a>
                                                                        <button class="btn btn-primary contentDelete" type="button" onclick="agentDel(<?php echo e($user->id); ?>)">delete</button>
                                                                    </td>
                                                                </tr>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible1="1">
                                    <form role="form" class="form" action="<?php echo e(url('admin/agent/new_agent')); ?>" method="post">
...
<script>
    ...
    function agentDel($id){
        var herf = '<?php echo e(url('/admin/agent/do_del_agent')); ?>' + '/' + $id;
        $('#basic').modal('show');

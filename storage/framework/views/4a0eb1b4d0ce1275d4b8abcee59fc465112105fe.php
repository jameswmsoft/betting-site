                                                            ...
                                                            <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td class="center" style="width: 22%;text-align: left">
                                                                        ...
                                                                        <a href="<?php echo e(url('admin/games/delete_pic_draw')); ?>/<?php echo e($data->id); ?>" class="btn btn-primary" type="button">Delete</a>
                                                                        <div style="display: block;margin-top: 10px">
                                                                            <a href="<?php echo e(url('admin/games/show_analyse_pic_draw')); ?>/<?php echo e($data->id); ?>" class="btn btn-primary contentDelete" type="button">ANALYSE</a>
                                                                            <a href="<?php echo e(url('admin/games/show_pic_winners')); ?>/<?php echo e($data->id); ?>" class="btn btn-primary contentDelete" type="button">WINNERS</a>
                                                                            <a href="<?php echo e(url('admin/games/show_pic_soldlist')); ?>/<?php echo e($data->id); ?>" class="btn btn-primary contentDelete" type="button">SOLD</a>
                                                                        </div>
                                                                    </td>

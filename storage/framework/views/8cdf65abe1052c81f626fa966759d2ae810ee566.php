                    ...
                    <div class="row" style="padding: 30px 20px 5px">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat red-intense">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <?php echo e($data['deposit_pending']); ?>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat blue-madison">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <?php echo e($data['withdraw_pending']); ?>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat purple-plum">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <?php echo e($data['total_withdraw']); ?> ₹
                                    </div>
                                    <div class="desc">
                                        TOTAL WITHDRAW
                                    </div>

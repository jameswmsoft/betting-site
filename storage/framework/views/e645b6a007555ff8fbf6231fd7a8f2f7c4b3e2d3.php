...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/bootstrap-datepicker/css/datepicker.css')); ?>"/>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/bootstrap-editable/bootstrap-editable/css/bootstrap-editable.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/bootstrap-editable/inputs-ext/address/address.css')); ?>"/>
    <!-- END PLUGINS USED BY X-EDITABLE -->
    <!-- BEGIN THEME STYLES -->
    <link href="<?php echo e(asset('assets/global/css/components-rounded.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/global/css/plugins.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/admin/layout3/css/layout.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/admin/layout3/css/themes/default.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/admin/layout3/css/custom.css')); ?>" rel="stylesheet" type="text/css">

    <link href="<?php echo e(asset('agent/css/layout.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('agent/css/darkblue.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('toastor/css/toastr.min.css')); ?>"rel="stylesheet" type="text/css">
    <!-- END THEME STYLES -->
    <link href="<?php echo e(asset('agent/css/agent.css')); ?>" rel="stylesheet" type="text/css"/>
<style>
            ...
            <ul class="nav navbar-nav pull-right">
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        ...
                        <li>
                            <a href="<?php echo e(url('admin/admin/show_admin_manage')); ?>">
                                <i class="icon-lock"></i> Manage Admin </a>
                        </li>

                        <li>
                            <a href="<?php echo e(url('admin/show_changepassword')); ?>">
...
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/bootstrap-datepicker/js/locales/bootstrap-datepicker.zh-CN.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/jquery.mockjax.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/bootstrap-editable/inputs-ext/address/address.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/bootstrap-editable/inputs-ext/wysihtml5/wysihtml5.js')); ?>"></script>
...
<script src="<?php echo e(asset('datapicker/demo.js')); ?>"></script>

<script src="<?php echo e(asset('assets/admin/pages/scripts/form-editable.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/admin/pages/scripts/form-icheck.js')); ?>"></script>

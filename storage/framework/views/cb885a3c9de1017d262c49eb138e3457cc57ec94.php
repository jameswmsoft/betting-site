                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading g_title g_pic_play">4D PRIME SOLD MANAGEMENT</div>
                                                ...
                                                <div class="portlet light">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <span class="caption-subject font-green-sharp bold uppercase">4D PRIME SOLD MANAGEMENT SYSTEM</span>
                                                        </div>
                                                        <div class="tools">
                                                            <div class="btn-group pull-right">
                                                                ...
                                                                <ul class="dropdown-menu pull-right">
                                                                    <?php $type = 1?>
                                                                    <li>
                                                                        <a href="<?php echo e(url('admin/games/getexcel_sold')); ?>/<?php echo e($drawID); ?>/<?php echo e($type); ?>">
                                                                            Export to Excel </a>
                                                                    </li>
                                                                </ul>
                                                            </div>

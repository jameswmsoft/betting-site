                        ...
                        <ul class="sub-menu">
                            ...
                            <li id="picgames">
                                ...
                                <ul class="sub-menu" style="display: block;">
                                    <li class="open">
                                        <a href="{{url('agent/games/winnerlist/0')}}" @if($type == 0) style="background-color: #0082ab!important;" @endif>
                                            <i class="icon-users"></i>
                                            3D LOT WINNERS</a>
                                    </li>
                                    <li>
                                        <a href="{{url('agent/games/winnerlist/1')}}" @if($type == 1) style="background-color: #0082ab!important;" @endif>
                                            <i class="icon-users"></i>
                                            4D PRIME WINNERS</a>
                                    </li>
                                </ul>

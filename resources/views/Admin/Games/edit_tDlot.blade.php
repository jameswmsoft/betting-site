                                        ...
                                        <div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible1="1">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 m_content">
                                                    <form class="form" action="{{url('admin/games/do_edit_tD_draw')}}/{{$Draw->id}}" method="post">
                                                        ...
                                                        <div class="tD_bet_body">
                                                            ...
                                                            <div class="col-md-5" style="padding-left: 0px">
                                                                <p>COST</p>
                                                                <p>
                                                                    <input type="text" id="tD_bet_cost" name="tD_bet_cost" class="col-md-12 form-control cost" value="{{$Draw->tDticketCost}}">
                                                            ...
                                                            <div class="row win_prize tD_bet_win_prize">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" id="tD_bet_prize_one" name="tD_bet_prize_one" class="col-md-12 form-control"  value="{{$Draw->tDprizeOne}}">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-6">
                                                                        <label>2 ODD</label>
                                                                        <label class="price_unit">₹</label>
                                                                        <input type="text" id="tD_bet_prize_two" name="tD_bet_prize_two" class="col-md-12 form-control"  value="{{$Draw->tDprizeTwo}}">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-6">
                                                                        <label>3 ODD</label>
                                                                        <label class="price_unit">₹</label>
                                                                        <input type="text" id="tD_bet_prize_thr" name="tD_bet_prize_thr" class="col-md-12 form-control"  value="{{$Draw->tDprizeThr}}">
                                                        ...
                                                        <div class="tD_bet_body">
                                                            ...
                                                            <div class="col-md-5" style="padding-left: 0px">
                                                                <p>COST</p>
                                                                <p>
                                                                    <input type="text" id="sD_bet_cost" name="sD_bet_cost" class="col-md-12 form-control cost" value="{{$Draw->sDticketCost}}">
                                                                    <label class="price_unit" style="padding-top: 3px">₹</label>
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div class="row win_prize tD_bet_win_prize">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-6">
                                                                        <label>1 ODD</label>
                                                                        <label class="price_unit">₹</label>
                                                                        <input type="text" id="sD_bet_prize_one" name="sD_bet_prize_one" class="col-md-12 form-control" value="{{$Draw->sDprizeOne}}">
                                                        ...
                                                        <div class="tD_bet_body">
                                                            ...
                                                            <div class="col-md-5" style="padding-left: 0px">
                                                                <p>COST</p>
                                                                <p>
                                                                    <input type="text" id="fD_bet_cost" name="fD_bet_cost" class="col-md-12 form-control cost" value="{{$Draw->fDticketCost}}">
                                                                    <label class="price_unit" style="padding-top: 3px">₹</label>
                                                                </p>
                                                            </div>
                                                            <!-- <p class="board_title">BOARD NUMBERS</p> -->
                                                            ...
                                                            <div class="row win_prize tD_bet_win_prize">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-6">
                                                                        <label>1 ODD</label>
                                                                        <label class="price_unit">₹</label>
                                                                        <input type="text" id="fD_bet_prize_one" name="fD_bet_prize_one" class="col-md-12 form-control" value="{{$Draw->fDprizeOne}}">
